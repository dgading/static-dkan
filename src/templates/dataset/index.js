...
import { Title, Text, Organization, FileDownload, Table, Tags } from 'interra-data-catalog-components';
...
class Dataset extends Component {
  ...
  async fetchData() {
    const id = this.props.pathContext.dataset.identifier;
    const { data } = await backend.get("/collections/dataset/" + id + ".json");
